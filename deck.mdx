...
<SyntaxHighlighter language='javascript' style={atomDark} customStyle={{minWidth:"500px"}}>
  {`const code = {
    example: [
      'one',
      'two'
...
<SyntaxHighlighter language='javascript' style={atomDark} customStyle={{width:"100%"}}>
  {`const code = {
    example: [
      'one',
      'two'
